...
_dbhostname = client.get_secret('HW10-2-DBHOSTNAME')
_dbusername = client.get_secret('HW10-2-DBUSERNAME')
_dbpassword = client.get_secret('HW10-2-DBPASSWORD')
_dbname = client.get_secret('HW10-2-DBNAME')
